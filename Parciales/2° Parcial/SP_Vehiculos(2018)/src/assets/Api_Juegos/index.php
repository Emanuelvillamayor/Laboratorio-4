...
$app->group('/usuario', function () {
    ...
    {  
        ...
        {
            $array=array("mail"=>$usuariosObtenidos["mail"],"nombre"=> $usuariosObtenidos["nombre"],"tipo"=> $usuariosObtenidos["tipo"]);
    ...
    {   
        ...
        try
        {
            $usuario=new Usuario($mail,$nombre,$tipo,$clave);
...
$app->group('/autos', function () {
    ...
    {   
        ...
        try
        {
            ...
            $vehiculo=new Vehiculo($patente,$color,$marca,$tipo,$km);
